      ...
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T3.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Mohammed Mozibur Rahman</h4>
                <hr>
                <p class="card-text">Barrister At Law, Advocate, Supreme Court of Bangladesh
                  Shantinagar, Dhaka.
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Mozibur Rahman is a skilled and talented lawyer who obtained his LL.B(Hon's)  degree from University of Wolverhampton, United Kingdom  and Postgraduate Diploma in Law from Northumbria University, United Kingdom  before he completed his Bar Vocational Course (BVC) from Lincoln’s Inn, United Kingdom.<br><br>

            Mr. Mozibur Rahman practices in the High Court Division of the Supreme Court of Bangladesh. His legal career in Bangladesh commenced  as an Associate in Amin & Associate, on of the top Civil Litigation Law Firms  founded and managed by Mr. Md. Nurul Amin, Senior Advocate, Supreme Court of Bangladesh.<br><br>
            
            He specializes in  Land Law,   Constitutional Law, Banking Law,  Intellectual Property (Trade mark, Copyright) Labour Law,  Customs Law,.</p><br>
