      ...
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T7.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Foysal Ahmed</h4>
                <hr>
                <p class="card-text">Advocate, Gazipur Judge Court
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Foysal possesses excellent knowledge on Sub-ordinate court litigation.  Since his enrolment in 2014, he has been practising in Gazipur District Judge Court providing legal services to his Clients in Gazipur on various legal issues. He has achieved practical experience both in conducting cases of both civil and criminal nature in the Sub-Ordinate Court. He regularly assists his clients in transfer of property, mutation, obtaining permission from different authorities.</p><br>
          <p>He is available for the following Services:</p>
            <li style="margin-left:40px ;">Civil & Criminal Litigation in Sub-ordinate court</li>
            <li style="margin-left:40px ;">Consultation and Advising</li>
            <li style="margin-left:40px ;">Representing Clients in before Courts and various authority</li>
            <li style="margin-left:40px ;">Drafting Documents</li>
            <li style="margin-left:40px ;">Assisting Clients in obtaining License, Permits etc. from different authorities.</li><br><br><br>
