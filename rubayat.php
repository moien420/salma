      ...
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T5.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Rubayat Jamil</h4>
                <hr>
                <p class="card-text">Advocate, Supreme Court of Bangladesh & Gazipur Judge Court
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Rubayat Jamil practices before  the District Judge Court Gazipur. He is a trial lawyer who conducts both civil and criminal cases in the sub-ordinate court. </p><br>
