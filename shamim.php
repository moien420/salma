...
<body>
     ...
     <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-primary">
      ...
      <br><br> 
       ...
       <!--proshanto start  hear-->
      

<section id="posanto"class="bg-light pt-5">
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T1.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Md. Shamim Darji</h4>
                <hr>
                <p class="card-text">Advocate, Supreme Court of Bangladesh<br>
                  +8801715488451<br>
                 Suite-7D1, 65/2/1, Paramount Heights, Purana Paltan, Dhaka.
                 </p>
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Shamim is currently practicing law in the High Court Division of the  Supreme Court of Bangladesh. He joined as an associate in a Dhaka based Corporate Law Firm namely C.T. Karim & Partners that deals with banking, company, land and securities law. He  subsequently became a Partner.  As a member of the firm, he worked with dozens of leading Banks, Financial Institutions, local and multinational Companies, Stock Broker, Merchant Banks and individuals.<br> 

            Mr. Shamim's litigation practice commenced with Molay & Associates, a renowned law Firm specializes on Family and civil matters in Dhaka. The Firm conducts its cases in Dhaka Judge Court. Later on he joined Khalekuzzaman & Associates, a Supreme Court based general practice law firm headed by Mr. A.S.M Khalequzzaman, Advocate, Appellate Division, Supreme Court of Bangladesh.<br>
            
            Later on, he joined one of the  top Civil Litigation Law Firms in Bangladesh namely Amin & Associates, headed by Senior Advocate Mr. Md. Nurul Amin.  The Firm is renowned for conducting complex land related litigation in the Supreme Court. </p><br><br>
            <button type="button" class="btn btn-primary btn-lg" style="width:180px ; float: right;">Shamim Darji</button>
            <button type="button" class="btn btn-primary btn-lg" style="width:180px;">Foysal Molla</button><br><br>
        </div>
      </div>
      
      <div class="col-md-4 bg-primary">
        <div style="width: 100%; height: 658px;">
        <h5 style="padding-top: 5px; margin-left: 5px;">Archives</h5>
        <div class="list">
        <ul>
      ...
      <h5 style="padding-top: 5px; margin-left: 5px;">Categories</h5>
        <div class="list">
        <ul>
          <li><a href="#">Business Law</a></li>
          <li><a href="#">Criminal Laws</a></li>
          <li><a href="#">Labour and Employment6</a></li>
      ...
      <a href="#">How To Get Anticipatory Bail In Bangladesh</a>
      <br>
      <a href="#">আইনপাল এর পক্ষ থেকে সবাইকে বাংলা নবভর্ষের শুভেচ্ছা।</a>
      <br>
      <a href="#">BSEC Introduces TREC Rules</a>
      <br>
      <a href="#">চাকুরীর অবসানজনীত পাওনাদি (শ্রম আইন)</a>
    </div>
        </div>
        </div>
      </div>
