      ...
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T6.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Monir Hossain</h4>
                <hr>
                <p class="card-text">Advocate, Dhaka Judge Court, Dhaka.
                  Dhaka, Bangladesh.
                 </p>
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Monir Hossain practices before  the District Judge Court, Dhaka. He conducts  family, civil and criminal cases in the sub-ordinate court. </p><br>
