      ...
      <div class="col-md-8">
        <div class="card mb-3" style="max-width: 612px; color: white;">
          <div class="row g-0 bg-primary">
            <div class="col-md-4">
              <img src="./image/T8.jpg" style="width: 200px; border-radius: 100px;" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <h4 class="card-title">Proshanta Chandra Sarker</h4>
                <hr>
                <p class="card-text">Advocate, Gazipur Judge Court
                  Gazipur, Dhaka, Bangladesh.</p>
        ...
        <div class="details">
          <p style="text-align:justify;">Mr. Sarker is a young and dynamic legal professional practicing in the Gazipur District Judge Court and Magistrate Courts (Subordinate Court). Despite being young, his brilliant display of litigation skills and professionalism made him popular amongst the lawyers of his Bar.  He was elected as a Member in the Executive Committee of Gazipur District Bar in 2017.<br><br>

            His specializes on subordinate Courts criminal and civil litigation including cases under Artharin Adalat Ain and Negotiable Instruments Act.<br>

            <br>His knowledge and experiences bundled with his sincerity, integrity has made him a got to lawyers for many.</p><br><br>
